...
public class album_activity extends AppCompatActivity {
    public static ArrayList<String> saved_album_names = new ArrayList<>();
    ArrayAdapter<String> adapter;
    private String api_key = "44ce572665909f50a88232d35e667812";

    public void changeAdapter(ArrayList<String> list) {
        ArrayAdapter<String> adapter;
...
//        //}
    ...
    class albumsAsync extends AsyncTask<String, Void, Void> {
        ArrayList<String> async_saved_album_names = new ArrayList<>();
        ...
        protected Void doInBackground(String... string) {
                        ...
                        if (hreEles != null) {
                            ...
                            if (lines.length > 2) {
                                ...
                                if (splitDate.length > 2) {
                                    ...
                                    Calendar today = Calendar.getInstance();
                                    if (albumDate.after(today)) {
                                        async_saved_album_names.add(artist_name + ": " + album_name + " -" + lines[1]);
                                    }
                                    ...
                                    if (Integer.parseInt(year) >= now_year) {
                                        async_saved_album_names.add(artist_name + ": " + album_name + " - " + year);
                                    }
                                }
                            } else { // not full date given - still a new album according to google
                                int year = Calendar.getInstance().get(Calendar.YEAR);
            ...
            album_activity.saved_album_names = async_saved_album_names;
            //System.out.println(async_saved_album_names.toString());
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            System.out.println(async_saved_album_names.toString());
            System.out.println(album_activity.saved_album_names.toString());
            changeAdapter(async_saved_album_names);
            //album_activity.saved_album_names = async_saved_album_names;
        }
    }
}